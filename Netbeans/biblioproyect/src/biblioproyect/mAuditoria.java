 ...
 * @author Hp Omen
 */
public class mAuditoria extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mAuditoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
